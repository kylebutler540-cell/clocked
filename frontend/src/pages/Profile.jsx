...
export default function Profile() {
  ...
  // Init GSI for callback when login modal opens
  useEffect(() => {
    if (!showLogin) return;
    const init = () => {
        ...
        <div className="modal-overlay" onClick={() => setShowLogin(false)}>
          <div className="modal-sheet" onClick={e => e.stopPropagation()}>
            ...
            <button
              ...
              style={{ borderRadius: 24, padding: '12px 20px', fontSize: 14, fontWeight: 600, marginBottom: 16, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10 }}
            >
